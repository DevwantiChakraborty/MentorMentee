...
<br>
  <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-form-label">Mentor Name</label>
    <div class="col-sm-10">

      <input name="mentor_name" type="text" class="form-control" id="colFormLabel" placeholder="Your Name" required>
...
<br>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      <input name="mentor_mobile" type="number" class="form-control" id="colFormLabel" placeholder="your Mobile Number" required>
