      ...
      <div class="container ">
          <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="col-6" >
                  <input type="text" class="form-control"  id="colFormLabel" placeholder="Mentee UID" name="mentee_uid" required>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group row">
                  <label for="colFormLabel" class="col-sm-4 col-form-label">Mentor ID</label>
                <div class="col-6" >
                  <input type="text" class="form-control"  id="colFormLabel" placeholder="Mentor ID" name="mentor_id" required>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="card-body">
      ...
      <div class="container ">
        ...
        <div class="row">
            ...
            <c:out value="${mentor_int_Details.interaction}" escapeXml="false" />  
            </c:if>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <c:out value="${department.name_department}" escapeXml="false" />  
            <br>
            </c:forEach>
            </c:if>
            <c:if test="${empty mentor_int_DetailsList}">  
  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="container ">
        ...
        <div class="col-lg-6" >
        <input name="date" type="date" class="form-control"  id="colFormLabel" placeholder="date" required>
        </div>
        <div class="col-lg-4" >
        ...
        <div class="p-1">
          ...
          <p class="p-4">
			...
			<c:if test="${not empty mentor_int_DetailsList}">  
			<c:forEach var="interaction" items="${mentor_int_DetailsList}">
    		<c:out value="${interaction.interaction}" escapeXml="false" />  <br>
  			</c:forEach>
			</c:if>
			<c:if test="${empty mentor_int_DetailsList}">  
			<c:out value="No Interaction details found." />  
        ...
        <div class="col-lg-12">
        <div class="form-group row">
        <label for="colFormLabel" class="col-sm-2 col-form-label">Problem Understood</label>
        <div class="col-12" >
        <div class="p-1">
          <div class="card" style="height:100px">
          <p class="p-4">
			...
			<c:if test="${not empty mentor_int_DetailsList}">  
			<c:forEach var="problem" items="${mentor_int_DetailsList}">
            ...
            <c:if test="${not empty mentor_int_Details}">  
            <c:out value="${mentor_int_Details.problem}" escapeXml="false" />  
            </c:if>
        ...
        <div class="p-1">
          ...
          <p class="p-4">
          	...
          	<c:if test="${not empty mentor_int_DetailsList}">  
			<c:forEach var="changes" items="${mentor_int_DetailsList}">
